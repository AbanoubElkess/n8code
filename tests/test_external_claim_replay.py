...
class TestExternalClaimReplayRunner(unittest.TestCase):
    ...
    def test_replay_converts_unverified_candidate_to_comparable_external(self) -> None:
        ...
        self.assertEqual(payload["before"]["total_claim_distance"], 1)
        self.assertEqual(payload["after"]["total_claim_distance"], 0)
        ...
        self.assertEqual(payload["delta"]["total_claim_distance_reduction"], 1)
        self.assertGreater(payload["delta"]["total_progress_ratio_gain"], 0.0)
    ...
    def test_replay_dry_run_does_not_mutate_distance(self) -> None:
        ...
        self.assertEqual(payload["before"]["total_claim_distance"], 1)
        self.assertEqual(payload["after"]["total_claim_distance"], 1)
        self.assertEqual(payload["delta"]["external_claim_distance_reduction"], 0)
        self.assertEqual(payload["delta"]["total_claim_distance_reduction"], 0)
        self.assertAlmostEqual(payload["delta"]["total_progress_ratio_gain"], 0.0)
